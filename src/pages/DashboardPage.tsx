...
export function DashboardPage() {
  ...
  return (
    <>
      <Reveal mode="mount" staggerIndex={0}>
        <PageHeader
      ...
      {statsLoading ? (
        <Reveal mode="mount" staggerIndex={1}>
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          ...
          <Reveal mode="mount" staggerIndex={2}>
            <StatCard
          ...
          <Reveal mode="mount" staggerIndex={3}>
            <StatCard
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <Reveal mode="inView" staggerIndex={0}>
          <Card>
        ...
        <Reveal mode="inView" staggerIndex={1}>
          <Card>
            <h2 className="text-base font-semibold text-foreground">
